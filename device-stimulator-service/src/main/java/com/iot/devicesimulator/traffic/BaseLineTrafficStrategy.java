...
@Component
@AllArgsConstructor
public class BaseLineTrafficStrategy implements TrafficStrategy {

    private final SimulatorConfig simulatorConfig;

    @Override
    public List<SensorReading> getTrafficInBatch() {
        return getTrafficInBatch(simulatorConfig.getDevicesPerNetwork());
    }

    @Override
    public TrafficProfile getType() {
        return TrafficProfile.BASELINE;
    }
}